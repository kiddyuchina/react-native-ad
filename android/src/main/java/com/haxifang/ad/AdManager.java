...
public class AdManager extends ReactContextBaseJavaModule {
    ...
    public void init(ReadableMap options) {
        ...
        AdBoss.splash_provider =
                options.hasKey("splash_provider")
                        ? options.getString("splash_provider")
                        : "头条";
        AdBoss.feed_provider =
                options.hasKey("feed_provider")
                        ? options.getString("feed_provider")
                        : "头条";
        AdBoss.reward_provider =
                options.hasKey("reward_provider")
                        ? options.getString("reward_provider")
                        : "头条";

        // codeids
        AdBoss.codeid_splash =
                options.hasKey("codeid_splash")
                        ? options.getString("codeid_splash")
                        : AdBoss.codeid_splash;
        AdBoss.codeid_splash_tencent =
                options.hasKey("codeid_splash_tencent")
                        ? options.getString("codeid_splash_tencent")
                        : AdBoss.codeid_splash_tencent;
        AdBoss.codeid_splash_baidu =
                options.hasKey("codeid_splash_baidu")
                        ? options.getString("codeid_splash_baidu")
                        : AdBoss.codeid_splash_baidu;

        if (options.hasKey("codeid_feed")) {
            AdBoss.codeid_feed = options.getString("codeid_feed");
        }
        AdBoss.codeid_feed_tencent =
                options.hasKey("codeid_feed_tencent")
                        ? options.getString("codeid_feed_tencent")
                        : AdBoss.codeid_feed_tencent;
        AdBoss.codeid_feed_baidu =
                options.hasKey("codeid_feed_baidu")
                        ? options.getString("codeid_feed_baidu")
                        : AdBoss.codeid_feed_baidu;

        AdBoss.codeid_draw_video =
                options.hasKey("codeid_draw_video")
                        ? options.getString("codeid_draw_video")
                        : AdBoss.codeid_draw_video;

        AdBoss.codeid_reward_video_tencent =
                options.hasKey("codeid_reward_video_tencent")
                        ? options.getString("codeid_reward_video_tencent")
                        : AdBoss.codeid_reward_video_tencent;
